  ...
  const customerHtml = `
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="detail-row" style="border-left-color:#f4a261;"><div class="detail-label">Inscripción</div><div class="detail-value" style="font-size:14px;color:#888;">$250 MXN única vez</div></div>
