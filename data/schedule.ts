...
export const weekdaySlots: ScheduleSlot[] = [
  ...
  { hour: '05:00', period: 'PM', className: 'After Work Ride', duration: '60 min', level: 'Todos los niveles', classColor: 'afterwork', instructorInitial: 'L', instructorName: 'Lucía Frescas González', instructorClass: 'avatar-lucia', status: 'available', spotsText: '11 disponibles', price: '$200 MXN' },
  { hour: '06:00', period: 'PM', className: 'Sunset Sprint', duration: '60 min', level: 'Todos los niveles', classColor: 'sunset', instructorInitial: 'L', instructorName: 'Lucía Frescas González', instructorClass: 'avatar-lucia', status: 'available', spotsText: '11 disponibles', price: '$200 MXN' },
  { hour: '07:00', period: 'PM', className: 'Night Climb', duration: '60 min', level: 'Todos los niveles', classColor: 'night', instructorInitial: 'L', instructorName: 'Lucía Frescas González', instructorClass: 'avatar-lucia', status: 'available', spotsText: '11 disponibles', price: '$200 MXN' },
];
