      ...
      <div className="container footer-grid">
        ...
        <div className="footer-col">
          ...
          <div className="socials">
            <a href="https://wa.me/526562929700" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="social-link">
            ...
            <a href="https://facebook.com/rideonspinning" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="social-link">
